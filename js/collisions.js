...
function traiteCollisionBalleAvecSol(b) {
...
function traiteCollisionsBalleAvecPlat(b) {
    if (!b instanceof BalleAvecVitesseXY) return;
    
    if (b.y + b.rayon > 650 && b.x >= balleChercheuse.x-100 && b.x <= balleChercheuse.x + 100) {
        b.y = 650 - b.rayon;
        b.vitesseY = -b.vitesseY-2;
    }
    score++;
  }
